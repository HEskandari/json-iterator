...
func Test_one_element(t *testing.T) {
	should := require.New(t)
	iter := jsoniter.ParseString(jsoniter.DefaultAPI(), `[1]`)
...
func Test_two_elements(t *testing.T) {
	should := require.New(t)
	iter := jsoniter.ParseString(jsoniter.DefaultAPI(), `[1,2]`)
	should.True(iter.ReadArray())
...
func Test_encode_byte_array(t *testing.T) {
	...
	bytes, err = jsoniter.DefaultAPI().Marshal([]byte{1, 2, 3})
	should.Nil(err)
	should.Equal(`"AQID"`, string(bytes))
}
...
func Test_encode_empty_byte_array(t *testing.T) {
	...
	bytes, err = jsoniter.DefaultAPI().Marshal([]byte{})
	should.Nil(err)
	should.Equal(`""`, string(bytes))
}
...
func Test_encode_nil_byte_array(t *testing.T) {
	...
	bytes, err = jsoniter.DefaultAPI().Marshal(nilSlice)
	should.Nil(err)
	should.Equal(`null`, string(bytes))
}
...
func Test_decode_byte_array_from_base64(t *testing.T) {
	...
	err = jsoniter.DefaultAPI().Unmarshal([]byte(`"AQID"`), &data)
	should.Nil(err)
	should.Equal([]byte{1, 2, 3}, data)
}
...
func Test_decode_byte_array_from_base64_with_newlines(t *testing.T) {
	...
	should.Nil(err)
	should.Equal([]byte{1, 2, 3}, data)
	err = jsoniter.DefaultAPI().Unmarshal([]byte(`"A\rQ\nID"`), &data)
	should.Nil(err)
	should.Equal([]byte{1, 2, 3}, data)
}
...
func Test_decode_byte_array_from_array(t *testing.T) {
	...
	should.Nil(err)
	should.Equal([]byte{1, 2, 3}, data)
	err = jsoniter.DefaultAPI().Unmarshal([]byte(`[1,2,3]`), &data)
	should.Nil(err)
	should.Equal([]byte{1, 2, 3}, data)
}
...
func Test_decode_slice(t *testing.T) {
	...
	jsoniter.DefaultAPI().UnmarshalFromString(`["hello", "world"]`, &slice)
...
func Test_decode_large_slice(t *testing.T) {
	should := require.New(t)
	slice := make([]int, 0, 1)
	jsoniter.DefaultAPI().UnmarshalFromString(`[1,2,3,4,5,6,7,8,9]`, &slice)
