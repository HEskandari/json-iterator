...
func Test_read_int32(t *testing.T) {
	...
	for _, input := range inputs {
		...
		t.Run(fmt.Sprintf("%v", input), func(t *testing.T) {
			should := require.New(t)
			iter := jsoniter.Parse(jsoniter.DefaultAPI(), bytes.NewBufferString(input), 2)
			expected, err := strconv.ParseInt(input, 10, 32)
			should.Nil(err)
			should.Equal(int32(expected), iter.ReadInt32())
		})
...
func Test_read_int_overflow(t *testing.T) {
	...
	for _, s := range inputArr {
		iter := jsoniter.ParseString(jsoniter.DefaultAPI(), s)
		iter.ReadInt8()
		should.NotNil(iter.Error)

		iterU := jsoniter.ParseString(jsoniter.DefaultAPI(), s)
		iterU.ReadUint8()
	...
	for _, s := range inputArr {
		...
		iterUint := jsoniter.ParseString(jsoniter.DefaultAPI(), s)
		iterUint.ReadUint16()
...
func Test_write_uint8(t *testing.T) {
	...
	for _, val := range vals {
		t.Run(fmt.Sprintf("%v", val), func(t *testing.T) {
			should := require.New(t)
			buf := &bytes.Buffer{}
			stream := jsoniter.NewStream(jsoniter.DefaultAPI(), buf, 4096)
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoniter.NewStream(jsoniter.DefaultAPI(), buf, 3)
	stream.WriteRaw("a")
...
func Test_write_int8(t *testing.T) {
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoniter.NewStream(jsoniter.DefaultAPI(), buf, 4)
	stream.WriteRaw("a")
...
func Test_write_uint16(t *testing.T) {
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoniter.NewStream(jsoniter.DefaultAPI(), buf, 5)
	stream.WriteRaw("a")
...
func Test_write_int16(t *testing.T) {
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoniter.NewStream(jsoniter.DefaultAPI(), buf, 6)
	stream.WriteRaw("a")
...
func Test_write_uint32(t *testing.T) {
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoniter.NewStream(jsoniter.DefaultAPI(), buf, 10)
	stream.WriteRaw("a")
...
func Test_write_int32(t *testing.T) {
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoniter.NewStream(jsoniter.DefaultAPI(), buf, 11)
	stream.WriteRaw("a")
